...
<FORM id=add_action enctype="multipart/form-data" method=post name=add.action action=/page/addHouse>
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
...
name=floorage></TD></TR>
  ...
  <TR>
    ...
    <TD>区：
      <SELECT class=text name=districtId id="district_id">
        <option value="">请选择</option>
    </SELECT>
...
<DIV class=buttons><INPUT type="submit" value=立即发布 type=button>
